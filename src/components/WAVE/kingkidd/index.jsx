  ...
  return (
    <>
      ...
      >
        ...
        >
          <a
            href="https://kingkiddphltd.co.ke/"
            target="_blank"
          ...
          >
            <RoundedButton className={styles.liveSiteButton}>
              <span style={{ position: "relative", zIndex: 2 }}>KingKidd</span>
              <span
                style={{
        ...
        >
          ...
          >
            ...
            >
              <h2 className={styles.nextCaseTitle}>INLINK</h2>
