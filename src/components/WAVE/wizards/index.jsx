      ...
      >
        ...
        >
          ...
          >
            <RoundedButton className={styles.liveSiteButton}>
              <span style={{ position: "relative", zIndex: 2 }}>Live site</span>
              <span
                style={{
        ...
        <div className={styles.imageGrid}>
          <img
            ...
            alt="wi1"
            data-scroll
            data-scroll-speed={isMobile ? "0.5" : "7"}
            data-scroll-direction="vertical"
        ...
        >
          ...
          >
            ...
            <div
              ...
              onClick={() => router.push("/wave/safaricom")}
              style={{ cursor: "pointer" }}
            >
              <h2 className={styles.nextCaseTitle}>Safaricom</h2>
          ...
          >
            ...
            <div className={styles.popupContent}>
              ...
              <div className={styles.popupImage}>
                <img src="/images/wid.jpg" alt="Maintenance" />
              </div>
            </div>
          </div>
        </div>
