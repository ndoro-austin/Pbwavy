  ...
  return (
    <>
      ...
      <div
        ...
        style={{ background: "#fff", height: "auto", width: "100%" }}
      >
        ...
        <div className={styles.container}>
          ...
          >
            ...
            <div className={styles.detail}>
              ...
              Production: HAUZ ENT <br />
              Production: Marcus Masila
            </div>
            <div className={styles.detail}>
        ...
        >
          ...
          >
            <RoundedButton className={styles.liveSiteButton}>
              <span style={{ position: "relative", zIndex: 2 }}>S-hook</span>
              <span
                style={{
        ...
        <video
          src={getMediaUrl("/images/svid.mp4")}
          autoPlay
          loop
          muted
          playsInline
        ...
        >
          ...
          >
            ...
            <div
              ...
              onClick={() => router.push("/wave/katana")}
              style={{ cursor: "pointer" }}
            >
              <h2 className={styles.nextCaseTitle}>M.katana</h2>
