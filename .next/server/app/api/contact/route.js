(()=>{var a={};a.id=746,a.ids=[746],a.modules={261:a=>{"use strict";a.exports=require("next/dist/shared/lib/router/utils/app-paths")},3295:a=>{"use strict";a.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},10846:a=>{"use strict";a.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},22522:(a,b,c)=>{"use strict";c.r(b),c.d(b,{handler:()=>B,patchFetch:()=>A,routeModule:()=>w,serverHooks:()=>z,workAsyncStorage:()=>x,workUnitAsyncStorage:()=>y});var d={};c.r(d),c.d(d,{POST:()=>v});var e=c(96559),f=c(48088),g=c(37719),h=c(26191),i=c(81289),j=c(261),k=c(92603),l=c(39893),m=c(14823),n=c(47220),o=c(66946),p=c(47912),q=c(99786),r=c(46143),s=c(86439),t=c(43365),u=c(32190);async function v(a){try{let{name:b,email:d,organization:e,services:f,message:g}=await a.json();if(!b||!d||!g)return u.NextResponse.json({error:"Please fill in all required fields"},{status:400});if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(d))return u.NextResponse.json({error:"Please provide a valid email address"},{status:400});if(process.env.RESEND_API_KEY)try{let{Resend:a}=await c.e(549).then(c.bind(c,20549)),h=new a(process.env.RESEND_API_KEY);return await h.emails.send({from:"Contact Form <onboarding@resend.dev>",to:process.env.CONTACT_EMAIL||"austinndoro03@gmail.com",replyTo:d,subject:`New Contact Form: ${b} - ${f||"General Inquiry"}`,html:`
            <!DOCTYPE html>
            <html>
              <head>
                <style>
                ...
                <div class="container">
                  ...
                  <div class="content">
                    ...
                    <div class="field">
                      ...
                      <div class="value"><a href="mailto:${d}">${d}</a></div>
                    </div>
                    ${e?`
                    <div class="field">
